...
<body class="bg-warning p-3 mb-2">
	<h1 class="display-4 fw-normal text-center m-5">Enter staff details</h1>
	<form action="AddstaffServlet" method="post">
		<div class="form-group row ">
			<label for="s_id" class="col-sm-2 col-form-label">Staff ID:</label>
			<div class="col-sm-10">
				<input type="text" name="s_id" maxlength="8"
					class="form-control shadow p-2 mb-3" id="s_id"
					placeholder="Enter staff_id" required>
			</div>
		</div>
		<div class="form-group row">
